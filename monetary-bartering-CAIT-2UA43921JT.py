...
then divide the value by 602 x 10^23 and round it off to the hundredths place
"""
...
def value_an_object(weight, elements_percentages):
    ...
    return '%.2f'%(object_value / (500000000000000000000000000))
...
# testing
print(value_an_object(1, {"H": .33, "O": .67}))